...
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports USER_CLK]
...
#set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33} [get_ports MCLK]
#set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33} [get_ports LRCK]
#set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33} [get_ports SCLK]
#set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports SDIN]
...
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports FPGA_SERIAL_TX]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports FPGA_SERIAL_RX]
...
#set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports AUDIO_PWM]
